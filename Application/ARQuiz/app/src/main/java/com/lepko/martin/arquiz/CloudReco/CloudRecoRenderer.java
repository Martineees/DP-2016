...
package com.lepko.martin.arquiz.CloudReco;
...
import com.lepko.martin.arquiz.Utils.CubeShaders;
import com.lepko.martin.arquiz.Utils.PlaneObject;
import com.lepko.martin.arquiz.Utils.SampleUtils;
import com.lepko.martin.arquiz.Utils.Teapot;
import com.lepko.martin.arquiz.Utils.Texture;
import com.lepko.martin.arquiz.Vuforia.VuforiaAppRenderer;
import com.lepko.martin.arquiz.Vuforia.VuforiaAppRendererControl;
...
public class CloudRecoRenderer implements GLSurfaceView.Renderer, VuforiaAppRendererControl
{
    ...
    private PlaneObject mPlaneObject;
    
    private CloudRecoActivity mActivity;

    private boolean mIsActive = false;
    
    public CloudRecoRenderer(VuforiaApplicationSession session, CloudRecoActivity activity)
    {
    ...
    private void renderAugmentation(TrackableResult trackableResult, float[] projectionMatrix)
    {
        ...
        GLES20.glDrawElements(GLES20.GL_TRIANGLES, mPlaneObject.getNumObjectIndex(),
            GLES20.GL_UNSIGNED_SHORT, mPlaneObject.getIndices());
